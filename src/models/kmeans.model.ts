...
interface IKMeans extends IKMeansSetting {
  initCenters: KMeansMethod1<number[][], number[][]>;
  calcDistances: KMeansMethod2<number[][], number[][], number[][]>;
  setLabels: KMeansMethod1<number[][], number[]>;
  moveCenters: KMeansMethod2<number[][], number[][], number[][]>;
  calcInertia: KMeansMethod3<number[][], number[][], number[], number>;
}
